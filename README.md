...
```bash
# 测试运行（1万条数据）
python main-bak.py --input data/sample.csv --output test --sample 10000

# 全量运行
python main-bak.py --input data/addresses.csv --output result --jobs 28

# 指定列名
python main-bak.py --input data/addresses.csv --address-col address --lon-col lng --lat-col lat

# 生成可视化报告
python main-bak.py --input data/addresses.csv --output result --visualize
```
